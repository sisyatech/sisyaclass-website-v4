        ...
        <div class="hero-content">
            <div class="hero-offer-block">
                ...
                <ul class="hero-feature-list">
                    ...
                    <li>✅ Choose Between 11 AM To 6 PM</li>
    ...
    <section class="stats-section2 stat-sec-3 stat-sec-5">
        <div class="smart-container">
            <div class="smart-text">
                ...
                <div class="demo-text">
                    <p>Grade 1-5 : Maths, EVS, English Demo</p>
                    <p>Grade 6-10 : Maths & 1 Science Demo</p>
                </div>
    ...
    <section class="how-it-works">
        ...
        <div class="steps">
            ...
            <div class="step-card step-1">
                ...
                <div class="step-text">Register For 1-1 Instant Demo Class @ ₹19</div>
            </div>
    ...
    <script>
        ...
        function initiateRazorpayPayment(orderData) {
            ...
            const options = {
                ...
                "modal": {
                    "ondismiss": function() {
                        updatePaymentStatus("failed").finally(() => {
                            const form = document.createElement('form');
                            form.method = 'POST';
                            form.action = 'failed.php';
