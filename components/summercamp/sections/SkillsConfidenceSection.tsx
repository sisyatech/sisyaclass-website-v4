                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                    {columns.map((col, idx) => (
                        <motion.div
                            ...
                            className="flex flex-col rounded-3xl overflow-hidden shadow-lg border border-white/50 bg-white group hover:shadow-2xl transition-all duration-300"
                        >
                            {/* Header */}
                            <div className={`${col.headerBg} p-5 flex flex-col items-center justify-center text-center min-h-[100px] md:min-h-[120px]`}>
                                <h3 className={`${col.titleColor} font-black text-base md:text-lg mb-1`}>
                                    {col.title}
                                </h3>
                                {col.subtitle && (
