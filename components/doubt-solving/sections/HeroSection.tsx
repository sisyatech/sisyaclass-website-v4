...
export default function HeroSection({ onRegister, onGetCallback }: HeroSectionProps) {
  ...
  return (
    <section className="relative w-full bg-[#01317A] text-white overflow-hidden min-h-[450px] sm:min-h-[480px] md:min-h-[520px] lg:min-h-[450px] xl:min-h-[550px] pt-4 pb-4 sm:pt-5 sm:pb-5 md:pt-6 md:pb-6 lg:pt-8 lg:pb-8 xl:pt-10 xl:pb-10">
      <div className="mx-auto flex w-full max-w-[1300px] lg:max-w-[1300px] xl:max-w-[1500px] 2xl:max-w-[1600px] flex-col gap-3 px-6 pb-4 sm:gap-3 sm:px-8 sm:pb-4 md:flex-row md:items-center md:justify-center md:gap-0 md:px-10 md:pb-6 lg:gap-0 lg:px-12 lg:pb-6 xl:gap-0 xl:px-16 xl:pb-0">
        {/* Left Column */}
        <div className={`w-full max-w-xl sm:max-w-lg md:max-w-xl lg:max-w-[580px] xl:max-w-[700px] mt-0 sm:-mt-2 md:-mt-3 lg:-mt-8 transition-all duration-[1000ms] ease-out ${entered ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-[80px]'}`}>
          {/* Main Headline */}
