...
export default function LtcContent2() {
  ...
  const handleReserveClick = async () => {
    ...
    try {
      if (typeof navigator !== "undefined" && navigator.geolocation) {
        ...
        try {
          ...
          // console.log("[LTC2] Raw Geo Data:", geoData);
    ...
    console.log("[LTC2] Final Location for Lead:", locationStr);
    ...
    try {
      ...
      window.location.href = `/ltc2/payment/success.php?transactionId=FREE_${Date.now()}&amount=${encodeURIComponent("Free")}`;
    } catch (err) {
