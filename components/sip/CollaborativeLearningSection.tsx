...
const CollaborativeLearningSection = () => {
  return (
    <section className="w-full bg-white">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 py-16 md:px-12 lg:px-0">
        <div className="space-y-3 text-left">
          <h2 className="text-[32px] font-bold text-[#1A2439] md:text-[40px]">
            Collaborative Learning Center
          </h2>
          <p className="text-base font-semibold text-[#0E90DA] md:text-lg">
            SISYA School Integration Program for JEE/NEET Foundation Grade 6 Onwards
          </p>
          <p className="text-sm text-[#1A2439]/80 md:text-base">
            At SISYA CLASS, we believe that every child deserves more than just a classroom. Our School Integration Program (SIP) is designed to transform schools into centres of academic and competitive excellence by combining:
          </p>
        </div>
        ...
        <div className="h-[88px] bg-[#0595CE] px-6 text-center text-sm font-medium text-white md:text-base flex items-center justify-center">
