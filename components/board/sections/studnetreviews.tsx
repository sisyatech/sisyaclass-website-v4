...
const Testimonials = ({ onRegister }: TestimonialsProps) => {
    ...
    return (
        <div id="testimonials" ref={sectionRef} className="py-1 sm:py-6 md:py-1 bg-white mt-30 mb-5 sm:mb-6 md:mb-8">
            <div className="mx-auto max-w-7xl px-4">
                {/* Headline */}
                ...
                <h3
                    className="mt-16 mb-0 font-montserrat font-normal text-[15px] leading-[26px] sm:text-[28px] sm:leading-[42px] md:text-[20px] md:leading-[30px] text-[#1A2439] text-center" >
