    ...
    <>
      ...
      <div className="w-full max-w-[360px] sm:max-w-[420px] md:max-w-[450px] bg-white shadow-md min-h-[80vh] md:min-h-0 md:rounded-md md:h-auto py-6 md:py-10">
        <div className="flex flex-col items-center justify-center text-center px-4 sm:px-5 py-6 md:py-10">
          ...
          <p className="text-[16px] text-[#555] leading-relaxed mb-6">Thank you for enrolling in our Board Demo Classes.</p>
          ...
          <a
            href={`https://wa.me/919100312034?text=${encodeURIComponent(
              `Hi, I just enrolled in the Board Classes. My transaction ID is ${transactionId}`
            )}`}
            target="_blank"
          ...
          <a
            href="/10thboards"
            className="mt-5 sm:mt-6 inline-flex items-center justify-center gap-2 bg-[#01317a] text-white rounded-md px-5 py-3 text-[15px] sm:text-[16px] font-medium shadow hover:bg-[#001d4a] transition-colors"
          >
            ← Back to Board Classes
          </a>
        </div>
      </div>
    </div>
