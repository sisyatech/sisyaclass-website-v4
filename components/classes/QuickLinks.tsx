  ...
  return (
    <RevealOnView from="bottom" durationMs={800} delayMs={0}>
      ...
      <div className="flex flex-wrap sm:flex-nowrap justify-center gap-2 sm:gap-2 md:gap-3 lg:gap-6">
        {/* Teachers Card */}
        <div className="cursor-pointer hover:scale-110 transition-all duration-300 animate-in fade-in zoom-in-50 delay-400">
        ...
        {/* Schedule Card */}
        <div className="cursor-pointer hover:scale-110 transition-all duration-300 animate-in fade-in zoom-in-50 delay-500">
          <div className="w-[70px] h-[53px] sm:w-[80px] sm:h-[60px] md:w-[85px] md:h-[64px] lg:w-[121px] lg:h-[93px] bg-white border-2 border-[#41AC7D] border-opacity-30 rounded-xl flex items-center justify-center">
            <Image 
        ...
        {/* Results Card */}
        <div className="cursor-pointer hover:scale-110 transition-all duration-300 animate-in fade-in zoom-in-50 delay-600">
          <div className="w-[70px] h-[53px] sm:w-[80px] sm:h-[60px] md:w-[85px] md:h-[64px] lg:w-[121px] lg:h-[93px] bg-white border-2 border-[#41AC7D] border-opacity-30 rounded-xl flex items-center justify-center">
            <Image 
        ...
        {/* Testimonials Card */}
        <div className="cursor-pointer hover:scale-110 transition-all duration-300 animate-in fade-in zoom-in-50 delay-700">
          <div className="w-[70px] h-[53px] sm:w-[80px] sm:h-[60px] md:w-[85px] md:h-[64px] lg:w-[121px] lg:h-[93px] bg-white border-2 border-[#41AC7D] border-opacity-30 rounded-xl flex items-center justify-center">
            <Image 
        ...
        {/* FAQs Card */}
        <div className="cursor-pointer hover:scale-110 transition-all duration-300 animate-in fade-in zoom-in-50 delay-800">
          <div className="w-[70px] h-[53px] sm:w-[80px] sm:h-[60px] md:w-[85px] md:h-[64px] lg:w-[121px] lg:h-[93px] bg-white border-2 border-[#41AC7D] border-opacity-30 rounded-xl flex items-center justify-center">
            <Image 
        ...
        {/* Demo Card */}
        <div className="cursor-pointer hover:scale-110 transition-all duration-300 animate-in fade-in zoom-in-50 delay-900">
          <div className="w-[70px] h-[53px] sm:w-[80px] sm:h-[60px] md:w-[85px] md:h-[64px] lg:w-[121px] lg:h-[93px] bg-white border-2 border-[#41AC7D] border-opacity-30 rounded-xl flex items-center justify-center">
            <Image 
