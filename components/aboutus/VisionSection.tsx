...
const VisionSection = () => {
  return (
    <RevealOnView from="right" durationMs={2000} delayMs={0}>
      <div className="w-full bg-[#1A2439] py-8 sm:py-12 md:py-16">
        <div className="max-w-7xl mx-auto w-full min-h-[200px] sm:min-h-[240px] md:min-h-[284px] flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 relative">
