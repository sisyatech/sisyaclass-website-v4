...
export default function ReviewsSection() {
  ...
  return (
    <div className="w-full max-w-[1000px] mx-auto py-5 px-4 box-border">
      <h2 className="text-center mb-1 font-bold text-[26px]">Real Impact. Results That Speak.</h2>
      <div className="text-center text-[#6b7280] text-[13px] mb-2">More than promises - results you can see</div>
      <div className="flex justify-center mb-[18px]">
        <img src="/3daylp/start.svg" alt="Start icon" className="h-5 w-auto" />
      </div>
