  ...
  return (
    <section className="relative w-full bg-white py-12 md:py-16 lg:py-20">
      <div className="mx-auto w-full max-w-[1400px] px-4 md:px-6 lg:px-8">
        ...
        <h2
          ref={titleRef}
          className={`font-roboto font-black text-[24px] leading-[32px] tracking-[0.03em] text-center md:text-[36px] md:leading-[48px] lg:text-[40px] lg:leading-[53px] mb-12 md:mb-16 transition-all duration-[1000ms] ease-out ${visibleSections.title ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-[40px]'}`}
        >
          What&apos;s Included
        </h2>
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-0 md:gap-1">
            ...
            <div className={`md:w-1/2 text-center md:text-right order-2 md:order-1 transition-all duration-[1000ms] ease-out ${visibleSections.section1 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-[60px]'}`} style={{ transitionDelay: visibleSections.section1 ? '200ms' : '0ms' }}>
              <h3 className="mb-4 font-bold text-[22px] leading-[28px] sm:text-[26px] sm:leading-[32px] tracking-normal text-center md:text-right md:text-[38px] md:leading-[46.67px]">
                Full Previous-Year Paper <br /> Solving (Live)
              </h3>
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-0 md:gap-1">
            ...
            {/* Text Content */}
            <div className={`md:w-1/2 text-center md:text-left transition-all duration-[1000ms] ease-out ${visibleSections.section2 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-[60px]'}`} style={{ transitionDelay: visibleSections.section2 ? '300ms' : '0ms' }}>
              <h3 className="mb-4 font-bold text-[22px] leading-[28px] sm:text-[26px] sm:leading-[32px] tracking-normal text-center md:text-left md:text-[38px] md:leading-[46.67px]">
                Answer-Writing Format <br /> Training
              </h3>
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-8 lg:gap-12">
            {/* Text Content - Right Aligned */}
            <div className={`md:w-1/2 text-center md:text-right order-2 md:order-1 transition-all duration-[1000ms] ease-out ${visibleSections.section3 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-[60px]'}`} style={{ transitionDelay: visibleSections.section3 ? '200ms' : '0ms' }}>
              <h3 className="mb-4 font-bold text-[22px] leading-[28px] sm:text-[26px] sm:leading-[32px] tracking-normal text-center md:text-right md:text-[38px] md:leading-[46.67px]">
                Speed & Accuracy <br />Improvement
              </h3>
            </div>

            {/* Image - Right Side */}
            <div className={`md:w-1/2 order-1 md:order-2 transition-all duration-[1000ms] ease-out ${visibleSections.section3 ? 'opacity-100 translate-x-0 scale-100' : 'opacity-0 translate-x-[60px] scale-95'}`} style={{ transitionDelay: visibleSections.section3 ? '300ms' : '0ms' }}>
              <div className="relative w-full max-w-[600px] mx-auto md:mx-0">
                <Image
                  src="/pyq/3.svg"
                  alt="SISYA AI"
