  ...
  return (
    <div className="py-6 sm:py-8 md:py-10 bg-white">
      <div className="mx-auto max-w-[1238px] px-4 sm:px-6">
        ...
        <p className="font-roboto font-medium text-[12px] leading-[14px] tracking-[0.03em] text-[#000000] mb-4 sm:mb-5 md:mb-6">
        ...
        <section className="mb-5">
          <h2 className="font-roboto font-bold text-[12px] leading-[14px] tracking-[0.03em] text-[#000000] mb-2 sm:mb-3">
            Information We Collect
          </h2>
          <ul className="list-none space-y-1 sm:space-y-2 pl-0">
            <li className="font-roboto font-medium text-[12px] leading-[14px] tracking-[0.03em] text-[#000000]">
          ...
          <p className="font-roboto font-medium text-[12px] leading-[14px] tracking-[0.03em] text-[#000000] mt-2">
        ...
        <section className="mb-5">
          ...
          <p className="font-roboto font-medium text-[12px] leading-[14px] tracking-[0.03em] text-[#000000] mb-2">
          ...
          <p className="font-roboto font-medium text-[12px] leading-[14px] tracking-[0.03em] text-[#000000]">
