  ...
  return (
    <section className="px-4 my-8">
      <div className="relative max-w-[950px] mx-auto rounded-[30px] p-6 overflow-hidden shadow-[0px_4px_4px_0px_#00000040]" style={{ background: "linear-gradient(90deg, #070963 0%, #352d9f 100%)" }}>
        ...
        <div className="relative grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 text-center">
          {items.map((it, idx) => (
            <div key={idx} className="relative p-3 md:p-4 after:hidden md:after:block after:content-[''] after:absolute after:top-0 after:right-0 after:w-px after:h-full after:[background:linear-gradient(180deg,rgba(255,255,255,0)_0%,#ffffff_50%,rgba(255,255,255,0)_100%)] md:last:after:hidden">
