...
const features: FeatureItem[] = [
    {
        ...
        imageSrc: "/backtoschool/icon/1.svg",
    },
    {
        title: "2 Months Free Revision Classes",
        imageSrc: "/backtoschool/icon/2.svg",
    },
    {
        title: "2 Months Free Summer Camp",
        imageSrc: "/backtoschool/icon/3.svg",
    },
    {
        title: "Monthly Workshops",
        imageSrc: "/backtoschool/icon/4.svg",
    },
    {
        title: "Four 1-1 special classes by IIT experts/month",
        imageSrc: "/backtoschool/icon/5.svg",
    },
    {
        title: "24/7 AI Doubt Solving / AI Quizes",
        imageSrc: "/backtoschool/icon/6.svg",
    },
    {
        title: "Get Detailed Performance Insights of students",
        imageSrc: "/backtoschool/icon/7.svg",
    },
    {
        title: "Advanced Study Material prepared by IITians",
        imageSrc: "/backtoschool/icon/8.svg",
    },
    {
        title: "Dedicated Academic Mentor",
        imageSrc: "/backtoschool/icon/9.svg",
    },
    {
        title: "SISYA Coins",
        imageSrc: "/backtoschool/icon/10.svg",
    },
];
