...
const TEACHERS_DATA: TeacherData[] = [
  {
    ...
    qualification: "IIT Gandhinagar",
    experienceText: "8+ Years of Experience",
    experienceYears: 8,
    imageUrl: "/backtoschool/5.png",
    order: 1,
  },
  {
    id: "2",
    name: "Ajay sir",
    designation: "Maths Master Teacher",
    qualification: "IIT Ropar",
    experienceText: "4+ Years Exp",
    experienceYears: 4,
    imageUrl: "/backtoschool/11.png",
    order: 2,
  },
  {
    id: "3",
    ...
    designation: "Maths Master Teacher",
    qualification: "IIT Gandhinagar",
    experienceText: "2+ Years Exp",
    experienceYears: 2,
    imageUrl: "/backtoschool/7.png",
    order: 3,
  },
  {
    id: "4",
    name: "Agraj Sir",
    designation: "Coding Master Teacher",
    qualification: "IIT Madras",
    experienceText: "2+ Years Exp",
    experienceYears: 2,
    imageUrl: "/backtoschool/3.png",
    order: 4,
  },
  {
    id: "5",
    name: "Barik Sir",
    designation: "Physics Master Teacher",
    qualification: "NIT Srinagar",
    experienceText: "2+ Years Exp",
    experienceYears: 2,
    imageUrl: "/backtoschool/16.png",
    order: 5,
  }
];
