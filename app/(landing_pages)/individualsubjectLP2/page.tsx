...
import IndividualSubjectLPContent from "@/components/individualsubjectLP2/IndividualsubjectLPContent";
import Script from "next/script";
import { getPageSchemas } from "@/lib/schemaApi";
import SchemaInjector from "@/components/SchemaInjector";

export default async function IndividualSubjectLPPage() {
  const schemas = await getPageSchemas('landing', 'individualsubjectLP');
