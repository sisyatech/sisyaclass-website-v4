...
import JeeFoundationContent from "@/components/jee_foundation_masterclass/JeeFoundationmasterclassContent";
import Script from "next/script";
import { getPageSchemas } from "@/lib/schemaApi";
import SchemaInjector from "@/components/SchemaInjector";

export default async function JeeFoundationPage() {
  const schemas = await getPageSchemas('landing', 'jee_foundation_masterclass');
